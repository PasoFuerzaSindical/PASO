...
const RealityWallPage: React.FC = () => {
    ...
    // Detectamos la URL completa incluyendo el hash para asegurar que el QR lleve al sitio exacto
    const appUrl = window.location.origin + window.location.pathname + "#/muro";
                ...
                <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl flex items-center justify-center p-4">
                    ...
                    <div className="flex flex-col items-center gap-6 max-w-full animate-in zoom-in-95 duration-300">
                        ...
                        >
                            ...
                            <div className="relative z-10 space-y-8 px-4">
                                <div className="space-y-2">
                                    ...
                                    <span className="text-brand-green font-mono text-[10px] tracking-[0.5em] uppercase">REALIDAD SANITARIA</span>
                                    <div className="h-px w-12 bg-brand-green mx-auto opacity-50"></div>
                                </div>
                                
                                <h2 className="text-3xl md:text-4xl font-black italic tracking-tighter text-white leading-[1.1] drop-shadow-2xl">
                                    "{sharingPost.text}"
                                </h2>
                                
                                <div className="flex justify-center gap-4 opacity-70 scale-90">
                        ...
                        <div className="flex flex-col gap-3 w-full">
                            ...
                            <p className="text-white/50 text-[10px] font-mono text-center uppercase tracking-widest">
                                Pulsa para guardar y subir a Instagram o WhatsApp
                            </p>
                        </div>
                    </div>
                </div>
